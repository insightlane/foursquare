...
results2019 <- foursquare %>%
        filter(Season == 2019, Status == "Original") %>%
        select(Round, Winner, Loser)

circle <- results2019 %>%
        left_join(results2019, c("Loser" = "Winner")) %>%
...
circle <- circle %>%
        left_join(results2019, c("Col3" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2019, c("Col4" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2019, c("Col5" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2019, c("Col6" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2019, c("Col7" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2019, c("Col8" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2019, c("Col9" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2019, c("Col10" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2019, c("Col11" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2019, c("Col12" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2019, c("Col13" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2019, c("Col14" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2019, c("Col15" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2019, c("Col16" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2019, c("Col17" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2019, c("Col18" = "Winner")) %>%
        select(-Round)

...
# Do this once - import to add in any other required match results from this round in the CSV

foursquare <- read.csv("C:/Local Code/insightlane/foursquare/output_files/afl_tables_match_results.csv",
                       stringsAsFactors = FALSE)
#circle <- read_csv("C:/Local documents/Analysis/FourSquare/circle.csv")

results2021 <- foursquare %>%
        filter(Season == 2021, Status == "Original") %>%
        filter(Winner != "Draw") %>%
        select(Round, Winner, Loser)

circle <- results2021 %>%
        left_join(results2021, c("Loser" = "Winner")) %>%
...
circle <- circle %>%
        left_join(results2021, c("Col3" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2021, c("Col4" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2021, c("Col5" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2021, c("Col6" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2021, c("Col7" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2021, c("Col8" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2021, c("Col9" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2021, c("Col10" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2021, c("Col11" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2021, c("Col12" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2021, c("Col13" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2021, c("Col14" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2021, c("Col15" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2021, c("Col16" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2021, c("Col17" = "Winner")) %>%
        select(-Round)
...
circle <- circle %>%
        left_join(results2021, c("Col18" = "Winner")) %>%
        select(-Round)
...
#write.csv(circle, file="circle21.csv")
